...
public:
    ...
    inline constexpr T const* offset_pointer(size_t offset) const { return this->m_values + offset; }
    inline constexpr T* offset_pointer(size_t offset) { return this->m_values + offset; }
    ...
    inline constexpr T const& at(size_t index) const
    {
    ...
    inline constexpr T const& last() const
    {
